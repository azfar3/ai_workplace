...
_DEFAULT_POLICIES: dict[str, str] = {
    ...
    # Attendance & Leave (No PIN required)
    "att_today": POLICY_NONE,
    "att_checkin": POLICY_NONE,
    "att_checkout": POLICY_NONE,
    "att_monthly": POLICY_NONE,
    "att_missing": POLICY_NONE,
    ...
    "my_profile": POLICY_PIN_REQUIRED,
    "prof_view": POLICY_PIN_REQUIRED,
    "prof_summary": POLICY_PIN_REQUIRED,
    "my_designation": POLICY_PIN_REQUIRED,
    "my_department": POLICY_PIN_REQUIRED,
    "my_branch": POLICY_PIN_REQUIRED,
    "get_employee_profile": POLICY_PIN_REQUIRED,
    "supervisor_reporting": POLICY_PIN_REQUIRED,
    "update_profile": POLICY_PIN_REQUIRED,
    "prof_my_requests": POLICY_PIN_REQUIRED,
    "prof_contact_update": POLICY_PIN_REQUIRED,
    "profile_gaps": POLICY_PIN_REQUIRED,
    "get_profile_gaps": POLICY_PIN_REQUIRED,
    ...
    # Salary & Payroll details (PIN required)
    "latest_salary_slip": POLICY_PIN_REQUIRED,
    "get_latest_salary_slip": POLICY_PIN_REQUIRED,
    "my_salary": POLICY_PIN_REQUIRED,
    "salary": POLICY_PIN_REQUIRED,
    "pay_download_slip": POLICY_PIN_REQUIRED,
    "pay_slip_latest": POLICY_PIN_REQUIRED,
    "pay_slip_3m": POLICY_PIN_REQUIRED,
    "pay_slip_6m": POLICY_PIN_REQUIRED,
    "doc_salary_slip": POLICY_PIN_REQUIRED,
    "tax_deductions": POLICY_PIN_REQUIRED,
    "get_tax_details": POLICY_PIN_REQUIRED,
    "pay_tax_deduction": POLICY_PIN_REQUIRED,
    "tax_cert_current": POLICY_PIN_REQUIRED,
    "tax_cert_previous": POLICY_PIN_REQUIRED,
    "tax_cert_latest": POLICY_PIN_REQUIRED,
    "doc_tax_cert": POLICY_PIN_REQUIRED,
    "pay_experience_letter": POLICY_PIN_REQUIRED,
    "doc_experience_letter": POLICY_PIN_REQUIRED,
    "pay_bank_letter": POLICY_PIN_REQUIRED,
    "pay_bank_faysal": POLICY_PIN_REQUIRED,
    "pay_bank_scb": POLICY_PIN_REQUIRED,
    "doc_bank_letter": POLICY_PIN_REQUIRED,
    "doc_contract": POLICY_PIN_REQUIRED,
    "doc_my_requests": POLICY_PIN_REQUIRED,
    "former_payslip": POLICY_PIN_REQUIRED,
    "former_letter": POLICY_PIN_REQUIRED,
    "payroll": POLICY_PIN_REQUIRED,
