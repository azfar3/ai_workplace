...
def get_employee_profile_gaps(employee_id: str) -> dict[str, Any]:
    ...
    report = {
        ...
        "employee_name": getattr(emp, "employee_name", "") or "",
        "employment_type": getattr(emp, "employment_type", "") or "",
        "department": getattr(emp, "department", "") or "",
        "designation": getattr(emp, "designation", "") or "",
        "branch": getattr(emp, "branch", "") or "",
        "company": getattr(emp, "company", "") or "",
        "date_of_joining": str(getattr(emp, "date_of_joining", "")) if getattr(emp, "date_of_joining", None) else "",
