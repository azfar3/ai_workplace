...
INTENT_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "guest_job_status": {
        "category": "careers",
        "intents": ["guest_job_status", "job_status", "application_status", "check_job_status"],
        "aliases": [
            "maine job apply ki thi uska status kese pata chalye ga",
            "how to check status of job applied",
            "job application status",
            "check my job application status",
            "how can i check my job status",
            "applied job status",
            "job apply status",
            "application status check",
            "interview status",
            "how to track job application",
        ],
        "tool": "get_careers_guide",
        "requires_authentication": False,
        "read_only": True,
        "requires_confirmation": False,
        "llm_allowed": False,
        "response_mode": "deterministic",
        "service_key": "guest_job_status",
        "source_type": "NAVIGATION",
    },

    "guest_careers": {
        "category": "careers",
        "intents": ["guest_careers", "apply_job", "job_openings", "careers"],
        "aliases": [
            "how to apply for job",
            "job vacancies",
            "open positions",
            "careers at micromerger",
            "job apply kaise karein",
