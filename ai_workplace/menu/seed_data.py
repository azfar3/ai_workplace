...
def get_menu_seed_items() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "submenus": [
                {"menu_key": "pay_download_slip", "title": "📥 Salary Slip", "title_urdu": "📥 سیلری سلپ", "title_roman_urdu": "📥 Salary Slip", "description": "Download latest payslip PDF.", "sequence": 1, "security_level": SEC_PIN},
                {"menu_key": "pay_previous_slips", "title": "📑 Previous Slips", "title_urdu": "📑 پچھلی سلپس", "title_roman_urdu": "📑 Previous Slips", "description": "Download 1, 3 or 6 months of payslips.", "sequence": 2, "security_level": SEC_PIN},
                {"menu_key": "pay_tax_deduction", "title": "🧾 Tax Certificate", "title_urdu": "🧾 ٹیکس سرٹیفکیٹ", "title_roman_urdu": "🧾 Tax Certificate", "description": "Tax deduction certificate.", "sequence": 3, "security_level": SEC_PIN},
                {"menu_key": "pay_experience_letter", "title": "📄 Experience Letter", "title_urdu": "📄 تجربہ سرٹیفکیٹ", "title_roman_urdu": "📄 Experience Letter", "description": "Service / experience certificate.", "sequence": 4, "security_level": SEC_PIN},
                {"menu_key": "pay_bank_letter", "title": "🏦 Bank Letter", "title_urdu": "🏦 بینک لیٹر", "title_roman_urdu": "🏦 Bank Letter", "description": "Bank account verification letter.", "sequence": 5, "security_level": SEC_PIN},
            ],
        },
        {
            "menu_key": "travel",
        ...
        },
        {
            "menu_key": "hr",
            "title": "👤 My HR & Profile",
            "title_urdu": "👤 میرا HR اور پروفائل",
            "title_roman_urdu": "👤 My HR & Profile",
            "user_category": "Active Employee",
            "sequence": 5,
            "description": "HR information, supervisor, documents and update requests.",
            "submenus": [
                ...
                {"menu_key": "supervisor_reporting", "title": "👨‍💼 Supervisor & HR Contact", "title_urdu": "👨‍💼 سپروائزر اور HR رابطہ", "title_roman_urdu": "👨‍💼 Supervisor & HR Contact", "description": "Supervisor and HR contact details.", "sequence": 20, "security_level": SEC_PIN},
                ...
                {"menu_key": "prof_my_requests", "title": "📋 My HR Requests", "title_urdu": "📋 میرے HR درخواستیں", "title_roman_urdu": "📋 My HR Requests", "description": "Track profile and HR change requests.", "sequence": 40, "security_level": SEC_PIN},
        ...
        },
        {
            ...
            "user_category": "Active Employee",
            "sequence": 6,
            "description": "Workplace guidance, safety and confidential HR matters.",
            "submenus": [
                {"menu_key": "staff_hr_guidance", "title": "📚 HR Guidance", "sequence": 1, "description": "Browse applicable HR policies.", "security_level": SEC_PIN},
                ...
                {"menu_key": "concerns", "title": "🔒 Confidential HR Matter", "sequence": 3, "description": "Report a confidential workplace concern.", "security_level": SEC_NONE},
        ...
        {
            "menu_key": "policies",
            "title": "📚 Policies & HR Help",
            "title_urdu": "📚 پالیسیاں اور HR مدد",
            "title_roman_urdu": "📚 Policies & HR Help",
            "user_category": "Active Employee",
            "sequence": 7,
            ...
            "submenus": [
                ...
                {"menu_key": "pol_ai_assistant", "title": "🤖 AI HR Assistant", "title_urdu": "🤖 AI HR اسسٹنٹ", "title_roman_urdu": "🤖 AI HR Assistant", "sequence": 2, "description": "Ask AI HR Assistant any policy or workplace question.", "security_level": SEC_NONE},
            ],
        },
        {
    ...
    return [
        {
            **common,
            ...
            "parent_menu_item": "pay_previous_slips",
            "flow_group": "salary_slip_period",
            "title": "📄 Last Month",
            "title_urdu": "📄 1 مہینہ",
            "title_roman_urdu": "📄 Last Month",
            "sequence": 1,
            "description": "Last month payslip (also offered after former_payslip).",
        ...
        },
        {
            **common,
            ...
            "sequence": 2,
            "description": "Last 3 months payslips (also offered after former_payslip).",
            "security_level": SEC_PIN,
        },
        {
            **common,
            ...
            "sequence": 3,
            "description": "Last 6 months payslips (also offered after former_payslip).",
            "security_level": SEC_PIN,
        },
        {
            **common,
