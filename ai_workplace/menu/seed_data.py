    ...
    return [
        {
            ...
            "submenus": [
                ...
                {"menu_key": "att_monthly", "title": "🗓️ Monthly Attendance", "title_urdu": "🗓️ ماہانہ حاضری", "title_roman_urdu": "🗓️ Monthly Attendance", "description": "Monthly attendance summary.", "sequence": 4, "security_level": SEC_NONE},
    ...
    return [
        ...
        },
        {
            **common,
            ...
            "parent_menu_item": "pay_download_slip",
            "flow_group": "salary_slip_period",
            "title": "Last 3 Salary Slips",
            "title_urdu": "پچھلی 3 سلپس",
            "title_roman_urdu": "Last 3 Slips",
            "sequence": 2,
        ...
        },
        {
            **common,
            ...
            "parent_menu_item": "pay_download_slip",
            "flow_group": "salary_slip_period",
            "title": "Last 6 Salary Slips",
            "title_urdu": "پچھلی 6 سلپس",
            "title_roman_urdu": "Last 6 Slips",
            "sequence": 3,
        ...
        {
            **common,
            "menu_key": "tax_cert_current",
            "parent_menu_item": "pay_tax_deduction",
            "flow_group": "tax_certificate_period",
            "title": "🧾 Current Year",
            "title_urdu": "🧾 موجودہ سال",
            "title_roman_urdu": "🧾 Current Year",
            "sequence": 1,
            "description": "Tax certificate for current fiscal year.",
            "security_level": SEC_PIN,
        },
        {
            **common,
            "menu_key": "tax_cert_previous",
            "parent_menu_item": "pay_tax_deduction",
            "flow_group": "tax_certificate_period",
            "title": "🧾 Previous Year",
            "title_urdu": "🧾 پچھلا سال",
            "title_roman_urdu": "🧾 Previous Year",
            "sequence": 2,
            "description": "Tax certificate for previous fiscal year.",
            "security_level": SEC_PIN,
        },
        {
            **common,
            "menu_key": "tax_cert_latest",
            "parent_menu_item": "pay_tax_deduction",
            "flow_group": "tax_certificate_period",
            "title": "🧾 Last Generated",
            "title_urdu": "🧾 تازہ ترین",
            "title_roman_urdu": "🧾 Last Generated",
            "sequence": 3,
            "description": "Tax certificate for the latest salary slip year.",
            "security_level": SEC_PIN,
        },
        {
            **common,
...
FLOW_GROUP_SPECS: dict[str, list[str]] = {
    "salary_slip_period": ["pay_slip_latest", "pay_slip_3m", "pay_slip_6m"],
    "tax_certificate_period": ["tax_cert_current", "tax_cert_previous", "tax_cert_latest"],
...
FLOW_GROUP_PROMPTS: dict[str, dict[str, str]] = {
    ...
    "tax_certificate_period": {
        "English": "Which fiscal year?",
        "Urdu": "کونسا مالی سال؟",
        "Roman Urdu": "Konsa fiscal year?",
    },
    "bank_letter_select": {
